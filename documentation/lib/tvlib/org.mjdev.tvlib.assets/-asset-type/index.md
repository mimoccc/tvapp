//[tvlib](../../../index.md)/[org.mjdev.tvlib.assets](../index.md)/[AssetType](index.md)
...
| [DIRECTORY](-d-i-r-e-c-t-o-r-y/index.md) | [androidJvm]<br>[DIRECTORY](-d-i-r-e-c-t-o-r-y/index.md) |
...
| Name | Summary |
|---|---|
| [compareTo](-d-i-r-e-c-t-o-r-y/index.md#1452595059%2FFunctions%2F-1596939238) | [androidJvm]<br>operator override fun [compareTo](-d-i-r-e-c-t-o-r-y/index.md#1452595059%2FFunctions%2F-1596939238)(other: [AssetType](index.md)): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html) |
...
| [valueOf](value-of.md) | [androidJvm]<br>fun [valueOf](value-of.md)(value: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)): [AssetType](index.md)<br>Returns the enum constant of this type with the specified name. The string must match exactly an identifier used to declare an enum constant in this type. (Extraneous whitespace characters are not permitted.) |
| [values](values.md) | [androidJvm]<br>fun [values](values.md)(): [Array](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-array/index.html)&lt;[AssetType](index.md)&gt;<br>Returns an array containing the constants of this enum type, in the order they're declared. |
...
| [parserClass](parser-class.md) | [androidJvm]<br>val [parserClass](parser-class.md): [KClass](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.reflect/-k-class/index.html)&lt;*&gt; |
