//[tvlib](../../../index.md)/[org.mjdev.tvlib.exception](../index.md)/[GenericMessageException](index.md)

# GenericMessageException

[androidJvm]\
class [GenericMessageException](index.md)(message: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)) : [Exception](https://developer.android.com/reference/kotlin/java/lang/Exception.html)

## Constructors

| | |
|---|---|
| [GenericMessageException](-generic-message-exception.md) | [androidJvm]<br>constructor(message: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)) |
