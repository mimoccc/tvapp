...
import org.mjdev.gradle.icons.LauncherIcon
import org.mjdev.gradle.icons.utils.Resources
import java.io.File
...
inline fun <reified T : Task> Task.runAfter() =
    tasks.byType<T>().finalizedBy(this)

inline fun <reified T : Task> Task.shouldRunAfter() =
    tasks.byType<T>().shouldRunAfter(this)
