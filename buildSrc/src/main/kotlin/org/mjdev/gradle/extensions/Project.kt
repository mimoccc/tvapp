...
val Project.iaAndroid: Boolean
    get() = extensions.findByType<ApplicationExtension>() != null

val Project.packageName: String
    get() = if (iaAndroid) android.defaultConfig.applicationId ?: "" else ""
...
val Project.variants: List<BaseVariant>
...
fun <T : Any> Project.extension(
    cls: KClass<T>,
): T? = extensions.findByType(cls.java)
